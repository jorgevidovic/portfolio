        ...
        <div className="grid items-center justify-center max-w-5xl gap-6 mx-auto md:grid-cols-2">
          <div className="max-w-[450px]">
            ...
            <p className="mb-6 text-base sm:text-lg md:text-lg lg:text-xl text-gray-300 text-center md:text-left leading-relaxed">
              ...
              <span className="font-bold text-white">Full Stack</span> con
              amplia experiencia en el diseño y desarrollo tanto en el{" "}
              <span className="font-bold text-white">Frontend</span> como en el{" "}
              <span className="font-bold text-white">Backend</span>. En el
              Frontend, manejo aspectos de diseño y desarrollo de interfaces,
              mientras que en el Backend, me especializo en la arquitectura de
              sistemas, lógica de negocio, y la gestión eficiente de bases de
              datos, entre otras áreas clave.
            </p>
            <button
