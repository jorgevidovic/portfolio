...
export const dataAboutPage = [
  {
    ...
    description:
      "Desarrollo Full Stack, abarcando todas las areas de desarrollo de producto, utilizando tecnologías .NET",
    date: "Actualidad",
  },
  {
    id: 2,
    ...
    description:
      "Desarrollo Full Stack y diseño de producto basado en los requerimientos del cliente.",
    date: "Actualidad",
  },
];
...
export const serviceData = [
  {
    ...
    title: "Frontend",
    description:
      "Desarrollo profesional de interfaces web intuitivas y atractivas, centradas en la experiencia del usuario",
  },
  {
    icon: <Computer />,
    title: "Backend",
